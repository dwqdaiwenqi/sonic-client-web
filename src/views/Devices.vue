          ...
          <el-collapse-item name="1">
            <template #title>
              ...
              <strong
                ...
                <div
                  :style="
                    'position: relative; display: flex;align-items: center;color:'(
                      avgTem < 300
                        ? '#67C23A'
                        : avgTem < 350
                        ? '#E6A23C'
  ...
  >
    ...
    >
      ...
      >
        <template #default>
          <div
            >当设备温度≥<span style="color: #409eff">高温值</span
            >时（仅安卓），会通知机器人告警。</div
          >
          <div
            >当<span style="color: #e6a23c">高温超时</span>时间内温度持续≥<span
              style="color: #409eff"
              >高温值</span
            >时（仅安卓），会通知机器人并<span style="color: #f56c6c">关机</span
            >。
          </div>
        </template>
      </el-alert>
